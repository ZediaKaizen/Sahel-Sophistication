...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/30">
      ...
      {/* Impact Stats */}
      <section className="py-24 relative z-20 bg-background border-t border-border/20">
        <div className="container mx-auto px-6 md:px-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-8 divide-x divide-border/20">
            {[
      ...
      {/* Condensed Mission */}
      <section className="py-32 relative z-20 bg-muted/40">
        <div className="container mx-auto px-6 md:px-12 max-w-5xl">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="mt-12">
              <Link href="/about" className="inline-flex items-center text-lg font-semibold text-foreground hover:text-primary transition-colors">
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          >
            ...
            <Link href="/our-projects">
              <div className="inline-flex items-center justify-center px-6 h-12 rounded-full hover:bg-foreground/5 font-medium transition-colors cursor-pointer group">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Kiru, Medile, and Tiga Water Projects", location: "Kano State, Nigeria", status: "Completed", image: "/project-kiru.jpg", slug: "kiru-medile-tiga" },
              { title: "Jirgabawa Solar-Powered Borehole", location: "Kano State, Nigeria", status: "Completed", image: "/project-jirgabawa.png", slug: "jirgabawa" },
              { title: "Kawo/Mariri Project", location: "Kano State, Nigeria", status: "Completed", image: "/project-kawo.jpg", slug: "kawo-mariri" },
            ].map((project, i) => (
              <motion.div
                key={i}
                initial="hidden"
      ...
      {/* Testimonial */}
      <section className="py-40 relative z-20 overflow-hidden bg-muted border-t border-border/20">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          ...
          >
            ...
            <div className="inline-flex items-center gap-4 text-left">
              <div className="w-12 h-12 rounded-full bg-muted-foreground/10 flex items-center justify-center font-semibold text-lg border border-border">
                A
              </div>
              <div>
      ...
      <section className="py-32 relative z-20 bg-background border-t border-border/20">
        <div className="container mx-auto px-6 md:px-12">
          <motion.div
            initial="hidden"
            whileInView="visible"
            ...
            {[
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-1">
                  ...
                  <Link href="/blog" className="inline-flex items-center text-sm font-semibold tracking-wide uppercase text-foreground hover:text-primary transition-colors w-fit">
                    Read More &rarr;
                  </Link>
                </div>
              </motion.div>
